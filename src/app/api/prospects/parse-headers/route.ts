...
const LABEL_SUGGESTIONS: Record<string, string> = {
  ...
  company_linkedin: "LinkedIn entreprise",
  companylinkedin: "LinkedIn entreprise",
  company_linkedin_url: "LinkedIn entreprise",
  summary: "Résumé",
  ...
  duree_poste: "Durée dans le poste",
  duree_entreprise: "Durée dans l'entreprise",
